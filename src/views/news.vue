...
<div id="news">
    ...
    <div class="main">
        <p class="title" style="margin-top: 87px; margin-bottom: 70px">
            交易平台
        </p>
        <div class="platform">
            <div class="platform_item" v-for="(item, index) in platformList" :key="index">
                <img :src="item.src" alt="platform" />
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            platformList: [{
                    src: require("../assets/img/platform/platform1.png"),
                },
                {
                    src: require("../assets/img/platform/platform2.png"),
                },
            ],
            swiperOption: {
                loop: true,
