<template>
<ul class="stack">
    <li class="stack-item" v-for="(item, index) in pages" :key="index" :style="[transformIndex(index),transform(index)]" @touchmove.stop.capture.prevent="touchmove" @touchstart.stop.capture.prevent="touchstart" @touchend.stop.capture.prevent="touchend" @touchcancel.stop.capture.prevent="touchend" @mousedown.stop.capture.prevent="touchstart" @mouseup.stop.capture.prevent="touchend" @mousemove.stop.capture.prevent="touchmove" @mouseout.stop.capture.prevent="touchend" @webkit-transition-end="onTransitionEnd(index)" @transitionend="onTransitionEnd(index)">
        ...
        <div class="card">
            <div class="left">
                ...
                <button :style="`background:${item.color}`" class="left_btn">立即免费入驻</button>
            </div>
            <div class="right">
                <p class="text">{{item.text}}</p>
                <div class="btn-group">
                    <div class="btn">快速开店通道</div>
                    <div class="btn">1对1客户经理</div>
                </div>
            </div>
